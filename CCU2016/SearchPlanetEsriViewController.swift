//
//  SearchPlanetEsriViewController.swift
//  CCU2016
//
//  Created by Semillero Esri Colombia SAS on 13/09/16.
...
class SearchPlanetEsriViewController:
    UIViewController,
    UISearchBarDelegate,
...
AGSQueryTaskDelegate {
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        ...
        self.query.whereClause = "fecha_inicio > DATE '2016/09/22' AND fecha_inicio < DATE '2016/09/23' AND nombre_sala = 'Sol 1' AND nombre_charla LIKE '%" + searchBar.text! + "%'"
